...
.style14 {font-size: 14px; font-weight: bold; color: #6666CC; }
...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
                    ...
                    <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="image"%>" style="width:200px; height:200px;"/></div></td>
						...
						<table>
						<tr>
						<td align="center" valign="middle"><span class="style14">Recommend By </span></td>
						<td align="center" valign="middle"><span class="style14">Username</span></td>
						<td align="center" valign="middle"><span class="style14">Group</span></td>
						<td align="center" valign="middle"><span class="style14">Recommend to </span></td>
						<td align="center" valign="middle"><span class="style14">Username</span></td>
						<td align="center" valign="middle"><span class="style14">Group</span></td>
						<td align="center" valign="middle"><span class="style14">Date</span></td>
						</tr>
                        <%
						...
						{ 
								...
								String query3="select id from user where username='"+u1+"' and grp='"+u2+"'"; 
                    ...
                    <input  name="image" type="image" src="profile_pic.jsp?id=<%=j%>&type=<%="user"%>" style="width:50px; height:50px;"/></div></td>
						  <td  width="81" valign="middle" align="center" height="51" style="color: #00CC99;"><span class="style16"><%=u1%></span></td>
						  <td  width="73" valign="middle" align="center" height="51"><span class="style16"><%=u2%></span></td>
					    
										
										<%
								}
								String query2="select id from user where username='"+u3+"' and grp='"+u4+"'"; 
								...
								%>
								<td width="109" align="center" valign="middle"><div class="style15" style="margin:10px 13px 10px 13px;" >
                    <input  name="image" type="image" src="profile_pic.jsp?id=<%=k%>&type=<%="user"%>" style="width:50px; height:50px;"/></div></td>
						  <td  width="73" valign="middle" align="center" height="51" style="color: #00CC99;"><span class="style16"><%=u3%></span></td>
						  <td  width="65" valign="middle" align="center" height="51"><span class="style16"><%=u4%></span></td>
						   <td  width="98" valign="middle" align="center" height="51"><span class="style16"><%=u5%></span></td>
						  </tr>
								<%
								}
