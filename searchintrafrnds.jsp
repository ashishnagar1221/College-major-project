...
<head>
<title>searching of same group friends</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3 style7">Search Intra(<span class="style6">Same Group </span>) Friends </p>
          <div class="clr"></div>
          <p>
	      <form action="intrafrndresults.jsp" method="post">
		     <table width="447">
            <tr>
              <td width="200" height="48"><span class="style4 style3">Search Friends with Name </span></td>
