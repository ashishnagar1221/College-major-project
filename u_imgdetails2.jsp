...
<%@page	import="java.util.*,java.text.SimpleDateFormat,java.util.Date,java.io.FileInputStream,java.io.FileOutputStream,java.io.PrintStream"%>
		  ...
		  {
		  %>
		  <form id="form1" name="form1" method="post" action="updaterank1.jsp?id=<%=i%>&itype=<%="dislike"%>&imgname=<%=s3%>">
		  	<tr>
		...
		<%}%>
		    ...
		    <table width="453">
		  <tr>
		 <h3>   <td width="330" align="center" valign="middle"> <div align="right"><a href="updaterank1.jsp?id=<%=i%>&itype=<%="like"%>">Like</a></div></td>
	
	  <td width="162" align="center" valign="middle"><div align="center"><a href="u_imgdetails2.jsp?id=<%=id%>&dislike=<%="dislike"%>"> Unlike</a></div></td></h3>
        ...
        <div class="article">
          <div align="right"><a href="viewrecommends.jsp">Back</a>
          </div>
