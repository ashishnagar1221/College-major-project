...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3 style7">Friend Requests  </p>
          <div class="clr"></div>
          <p>
	     <table >
	...
	ArrayList al=new ArrayList();
		...
		while(rs1.next())
		{
			...
			al.add(s2);
				...
				String sql="select id from user where username='"+s2+"' and grp='"+s1+"'";
				...
				<img height="100" width="100" src="profile_pic.jsp?id=<%=i%>&type=<%="user"%>" />	
				 ...
				 <figcaption>
				 <h3 class="style8">Group: <span class="style11"><%=s1%></span> </h3>
