...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		<%
						...
						{	
							...
							String query1="select id,imgname,tagname,description from images where username!='"+user+"' and grp='"+grp+"'"; 
				...
				<a href="updaterank.jsp?id=<%=i%>&itype1=<%="intra"%>&itype=<%="view"%>&key=<%=key%>">View Details</a><br />
				<form action="recommends.jsp?id=<%=i%>&gp=<%=grp%>&key=<%=key%>&type1=<%="same"%>" method="post">
				 <%
				 String sql="select rfrom from friends where (rto='"+user+"' and fromgrp='"+grp+"' and status='Accepted')";
				 ...
				 String sql2="select rto from friends where (rfrom='"+user+"' and togrp='"+grp+"' and status='Accepted')";
	  ...
	  <h2 class="style25" ><%=msg%></h2>
        ...
        <div class="article">
          <p align="right"><a href="search_samegrpimgs.jsp">Back</a></p>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
